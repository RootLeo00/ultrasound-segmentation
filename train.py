...
from main import IMAGE_SIZE, model_dir, MODEL_NAME, NUM_CLASSES, BATCH_SIZE, EPOCHS
...
from load_dataset import train_input_img_paths, train_mask_img_paths, test_input_img_paths, test_mask_img_paths
...
def train():
    ...
    if MODEL_NAME=="unet":
        ...
        model = unet(input_size=IMAGE_SIZE, num_classes=NUM_CLASSES)
    elif MODEL_NAME=="TRANSFER_LEARNING_VGG16":
        from models.vgg16 import TL_unet_model
        model = TL_unet_model(input_shape=IMAGE_SIZE, NUM_CLASSES=NUM_CLASSES)
