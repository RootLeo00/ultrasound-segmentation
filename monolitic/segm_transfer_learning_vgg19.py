...
checkpoint_path = model_dir+'/vgg19_transfer_learning.hdf5'
...
monitor='val_accuracy'
early_stopping = EarlyStopping(monitor=monitor, patience=20, verbose=1, mode="auto") #Stop training when a monitored metric has stopped improving.
...
TL_checkpoint_path = model_dir+'/vgg19_transfer_learning.hdf5'
TLmodel = load_model(TL_checkpoint_path)#'weightedLoss': weightedLoss,  ## custom_objects={'recall': recall, 'precision': precision }
